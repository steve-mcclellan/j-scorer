...
$(function() {
  ...
  function populateBoard() {
    ...
    if ( currentRound === "round1" || currentRound === "round2" ) {
      ...
      for ( var col = 1; col <= 6; col++ ) {
        ...
        $catTitleP.html( roundObject[col][0][0] );
        $catTitleP.blur();  // Applies appropriate formatting.
    ...
    updateScoreboard();
    }  // TODO: else for Final being current round goes here.
  }
  ...
  // console.log(Cookies.getJSON('testname'));

  // setCookie( 'testname2', '470' );
  // console.log(getCookie('testname2'));
  // console.log(Cookies.getJSON('testname2'));

  // console.log(getCookie());
  // destroyCookie('testname');
  // console.log(getCookie());
  ...
  $( "#game-container .topic-area" ).on ("blur", function() {
    var $elem = $( this );
